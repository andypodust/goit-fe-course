...
const getAllNames = arr => arr.map(elem => elem.name);
 ...
 */
const getUsersByGender = (arr, gender) => arr.filter(elem => elem.gender === gender)
 ...
 */
const getInactiveUsers = arr => arr.filter(elem => !elem.isActive)
 ...
 */
const getUserByEmail = (arr, email) => arr.find(elem => elem.email === email)
 ...
 */
const getUsersWithAge = (arr, min, max) => arr.filter(elem => elem.age > min && elem.age < max)
 ...
 */
const getTotalBalance = arr => arr.reduce((acc, elem) => acc + elem.balance, 0)
 ...
 */
const getUsersByFriend = (arr, name) => arr.filter(elem => elem.friends.includes(name))
